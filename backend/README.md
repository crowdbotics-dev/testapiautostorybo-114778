...
## Project Structure
    ...
    ├── testapiautostorybo_114778  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_114778`
...
2. Clone this repo and `cd testapiautostorybo_114778`
